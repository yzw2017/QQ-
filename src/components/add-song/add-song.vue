  ...
  <transition name="slide">
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="search-box-wrapper">
        <search-box ref="searchBox" @query="updateQuery" :placeholder="'搜索歌曲'"></search-box>
      </div>
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          ...
          <scroll ref="searchList"  :refresh-delay="refreshDelay" class="list-scroll" v-if="currentIndex === 1" :data="searchHistory">
            <div class="list-inner">
